...
# EvaluacionSerializer eliminado
from .serializers import CitaSerializer, ClienteSerializer, OdontogramaSerializer, RadiografiaSerializer
...
# Función eliminada - sistema de evaluaciones desactivado

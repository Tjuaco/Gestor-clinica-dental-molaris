...
class Cita(models.Model):
    ...
    def completar(self):
        """Marca una cita como completada. Acepta estados 'reservada' o 'finalizada'"""
        if self.estado in ['reservada', 'finalizada']:
...
# Modelo para gestionar salas de atención
class Sala(models.Model):
    """Modelo para gestionar las salas de atención de la clínica"""
    ...
    def dentistas_asignados(self):
        """Retorna los dentistas asignados a esta sala"""
        return self.dentistas.filter(activo=True, rol='dentista')

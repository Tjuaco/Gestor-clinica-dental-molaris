...
from . import views_salas

urlpatterns = [
    # Auth trabajadores
    path('', views.inicio, name='inicio_trabajadores'),
    ...
    path('exportar-estadisticas-pdf/', views_reportes.exportar_estadisticas_pdf, name='exportar_estadisticas_pdf'),
    ...
    # Gestión de salas
    path('salas/', views_salas.gestor_salas, name='gestor_salas'),
    path('salas/crear/', views_salas.crear_sala, name='crear_sala'),
    path('salas/<int:sala_id>/editar/', views_salas.editar_sala, name='editar_sala'),
    path('salas/<int:sala_id>/eliminar/', views_salas.eliminar_sala, name='eliminar_sala'),
    path('salas/dentista/<int:dentista_id>/asignar/', views_salas.asignar_sala_dentista, name='asignar_sala_dentista'),
    ...
    path('auditoria/limpiar/', views_auditoria.limpiar_auditoria, name='limpiar_auditoria'),
    path('auditoria/estadisticas/', views_auditoria.estadisticas_auditoria, name='estadisticas_auditoria'),

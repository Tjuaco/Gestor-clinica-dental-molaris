...
class PlanTratamiento(models.Model):
    ...
    def puede_ser_editado_por(self, perfil):
        """Verifica si un perfil puede editar este plan - Solo administrativos pueden editar y solo si está en pendiente_aprobacion"""
        if not perfil.es_administrativo():
            return False
        # Solo se puede editar si está en pendiente_aprobacion (antes de ser aprobado)

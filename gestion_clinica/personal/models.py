...
class Perfil(models.Model):
    ...
    # Sala asignada (solo para dentistas)
    sala_asignada = models.ForeignKey(
        ...
        help_text="Sala donde trabaja este dentista"
    )
    ...
    def get_estadisticas_pacientes(self):
        """Retorna estadísticas de los pacientes del dentista (optimizado)"""
        ...
        # Optimizar: calcular fecha una sola vez
        ...
        return {
            ...
            'citas_hoy': citas_pacientes.filter(fecha_hora__date=hoy).count(),
        }
